...
\hitsetup{
  ...
  ctitlecover={基于分布式协同算法的无人机集群搜索研究},%放在封面中使用，自由断行
  ctitle={基于分布式协同算法的无人机集群搜索研究},%放在原创性声明中使用
...
摘要的字数（是什么），硕士学位论文一般为500 $\sim$ 1000字，博士学位论文为1000 $\sim$ 2000字，
